...
func debug(message: String) -> void:
	# 调试
	write_entry(Entry.new(message, Level.DEBUG))
	
#---------------------------------------------------------------------------------------------------
func info(message: String) -> void:
	# 常规
	write_entry(Entry.new(message, Level.INFO))

#---------------------------------------------------------------------------------------------------
func notice(message: String) -> void:
	# 消息
	write_entry(Entry.new(message, Level.NOTICE))
	
#---------------------------------------------------------------------------------------------------
func warning(message: String) -> void:
	# 警告
	write_entry(Entry.new(message, Level.WARNING))

#---------------------------------------------------------------------------------------------------
func error(message: String) -> void:
	# 错误
	write_entry(Entry.new(message, Level.ERROR))
